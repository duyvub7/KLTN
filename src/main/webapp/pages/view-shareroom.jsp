        ...
        <div class="container">
            <div class="col-8 row mt-2 mx-auto">
                ...
                <div class="col-4 pl-5">
                    <select class="form-control form-control-sm py-0 select-ssm with-150" onChange="window.location.href='${contextPath}/shareroom/'+this.value">
                                ...
                                <div class="modal fade" id="textbox" aria-labelledby="textbox">
                                    <div class="modal-dialog">
            							<div class="modal-content">
            								<form action="add-shareroom" method="POST" enctype="multipart/form-data">
	                                    ...
	                                    <span class="post-time">
	                                    	...
	                                    	<c:choose>
	                                    		<c:when test="${post.post_status == true }">
	                                    			<strong class="pl-3">Đang tìm kiếm</strong>
	                                    		</c:when>
	                                    		<c:otherwise>
	                                    			<strong class="pl-3">Đã xong</strong>
	                                    		</c:otherwise>
	                                    	</c:choose>
	                                    </span>
	                                    <p>
