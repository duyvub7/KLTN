        ...
        <div class="container">
            <div class="col-8 row mt-2 mx-auto">
                ...
                <div class="col-4 pl-5">
                    <select class="form-control form-control-sm py-0 select-ssm with-150" onChange="window.location.href='${contextPath}/utensil/'+this.value">
                                ...
                                <div class="modal fade" id="textbox" aria-labelledby="textbox">
                                    <div class="modal-dialog">
            							<div class="modal-content">
            								<form action="add-utensil" method="POST" enctype="multipart/form-data">
	                                            <div class="modal-header">
	                                                <h5 class="modal-title">Nhập thông tin đồ dùng muốn bán</h5>
