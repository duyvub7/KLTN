        ...
        <nav class="navbar header-navbar pcoded-header background-light">
            <div class="navbar-wrapper">
                ...
                <div class="navbar-container container-fluid">
                    <div class="nav-left">
                                <h4 class="ml-3 mt-3">Quản lý thông báo</h4>
                    </div>
                    <div class="nav-right">
                                                    ...
                                                    <table id="single-select" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        	<c:forEach var="noti" items="${listNotification }">
                                                        		<tr>
	                                                                <td>${noti.notification_content }</td>
	                                                                <td>${fn:substring(noti.time, 0, 16) }</td> 
	                                                                <td>Tài khoản</td>
	                                                                <td>
																		<button class="btn-lock">Xóa</button>
	                                                                </td>
	                                                            </tr>
                                                        	</c:forEach>
                                                        	<tr>
                                                                <td>Khuyến nghị mọi người không nên chia sẻ mật khẩu...</td>
                                                                <td>2021-04-15 20:00</td> 
                                                                <td>Toàn bộ</td>
                                                                <td>
																	<button class="btn-lock">Xóa</button>
                                                                </td>
